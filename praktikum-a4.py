...
#latihan list
data  =['Retno Helviani',2023,'Aktif']
nilai =[45,58,100,75]
print('Nama:  '+ data[0])
...
print(f'Data rata-rata nilai adalah\t:{sum(nilai)/len(nilai)}')
...
matkul = ['Agama Kristen','Pancasila','Bahasa Indonesia','Wawasan Cinta IPTEK dan IMTAQ']
sks    = [2,2,2,2]
